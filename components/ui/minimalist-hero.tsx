...
const SocialIcon = ({ href, icon }: { href: string; icon: string }) => {
    let IconComponent;
    if (icon === "twitter") IconComponent = Twitter;
    else if (icon === "instagram") IconComponent = Instagram;
    else if (icon === "github") IconComponent = Github;
    else return null;
...
export const MinimalistHero = ({
    ...
    return (
        ...
        >
            ...
            {/* Main Content Area */}
            <div className="relative mt-12 mb-12 grid w-full max-w-7xl flex-grow grid-cols-1 items-center gap-12 md:mt-0 md:mb-0 md:grid-cols-3 md:gap-0">
                {/* Left Text Content */}
                <motion.div
                ...
                <div className="relative order-1 md:order-2 flex justify-center items-center h-full min-h-[300px]">
                    ...
                    <motion.img
                        src={imageSrc}
                        alt={imageAlt}
                        className="relative z-10 h-auto w-56 object-cover md:w-64 scale-150 lg:w-72 shadow-xl"
