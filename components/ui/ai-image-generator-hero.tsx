    ...
    return (
        <div className="relative w-full min-h-screen bg-gradient-to-b from-background via-background to-background overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
                ...
                {/* Content Section */}
                <div className="relative z-20 w-full flex flex-col items-center justify-center text-center max-w-5xl mx-auto mb-12 sm:mb-16">
                    <h1 className="text-6xl sm:text-8xl lg:text-9xl font-[family-name:var(--font-cute-font)] text-foreground mb-4 sm:mb-6 whitespace-nowrap overflow-visible">
                        {title}
                    </h1>
